...
class ServerModel with ChangeNotifier {
  ...
  toggleService() async {
    if (_isStart) {
      ...
      // Simi Next Support is a closed product — operators want the
      // service on, not a confirmation dialog. Skip the "service will
      // start" prompt and start immediately. The Android system
      // MediaProjection consent prompt still appears on first run.
      startService();
    }
  }
